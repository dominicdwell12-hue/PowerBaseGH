  ...
  return (
    <div className="grid gap-6 sm:grid-cols-2">
      <div className="relative overflow-hidden rounded-2xl bg-ink p-6 text-paper sm:p-8">
        ...
        <Headphones size={72} className="absolute -bottom-2 right-6 text-ink-600" aria-hidden="true" />
      </div>
      ...
      <div className="relative overflow-hidden rounded-2xl bg-gold-50 p-6 sm:p-8">
        ...
        <Sparkle size={72} className="absolute -bottom-2 right-6 text-gold-100" aria-hidden="true" />
      </div>
    </div>
  );
}
